#include "ChrisMoat.hpp"
#include "Unit.hpp"

lionheart::Placement lionheart::ChrisMoat::placeUnit(UnitType,
                                              StartBox const &box,
                                              SituationReport report)
{
  ...
  lionheart::Action
lionheart::ChrisMoat::recommendAction(Unit const &, SituationReport, Plan)
{
...
lionheart::Blazon lionheart::ChrisMoat::getBlazon()
{
  ...
  return { Color::VERT, Color::GULES, Style::BEND, "Chris Moat" };
}
