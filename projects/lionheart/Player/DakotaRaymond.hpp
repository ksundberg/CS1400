#ifndef LIONHEART_DAKOTA_RAYMOND
#define LIONHEART_DAKOTA_RAYMOND
#include "Player.hpp"

namespace lionheart
{
  class DakotaRaymond : public Player
  {
  public:
    DakotaRaymond()
    {
    ...
    Blazon getBlazon() { return {Color::OR, Color::VERT, Style::BEND, "Dakota Raymond"}; }
  private:
    Placement crown;
  };
}
