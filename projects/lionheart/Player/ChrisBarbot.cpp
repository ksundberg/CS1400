#include "ChrisBarbot.hpp"

lionheart::Placement lionheart::ChrisBarbot::placeUnit(UnitType,
                                              StartBox const &box,
                                              SituationReport report)
{
  ...
  lionheart::Action
lionheart::ChrisBarbot::recommendAction(Unit const &, SituationReport, Plan)
{
...
lionheart::Blazon lionheart::ChrisBarbot::getBlazon()
{
  ...
  return { Color::VERT, Color::GULES, Style::PER_BEND, "Chris Barbot" };
}
