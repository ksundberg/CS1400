#ifndef LIONHEART_ANTONINO_AGUILAR
#define LIONHEART_ANTONINO_AGUILAR
#include "Player.hpp"

namespace lionheart
{
  class AntoninoAguilar : public Player
  {
  public:
    ...
    Blazon getBlazon() { return {Color::GULES, Color::OR, Style::QUARTERLY, "Antonino Aguilar"}; }
  };
}
#endif
