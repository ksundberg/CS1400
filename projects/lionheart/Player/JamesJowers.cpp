...
// placement function
lionheart::Placement lionheart::JamesJowers::placeUnit(UnitType,
                                                        StartBox const& box,
...
lionheart::Action lionheart::JamesJowers::recommendAction(
...
lionheart::Blazon lionheart::JamesJowers::getBlazon()
{
  return {Color::SABLE,
          Color::GULES,
          Style::BEND,
