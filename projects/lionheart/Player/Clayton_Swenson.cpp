#include "Clayton_Swenson.hpp"

lionheart::Placement lionheart::Clayton_Swenson::placeUnit(UnitType,
                                              StartBox const &box,
                                              SituationReport report)
{
  ...
  lionheart::Action
lionheart::Clayton_Swenson::recommendAction(Unit const & u, SituationReport, Plan p)
{
    if (u.getType() == CROWN) {
        return wait();
    }
...
lionheart::Blazon lionheart::Clayton_Swenson::getBlazon()
{
  ...
  return { Color::GULES, Color::SABLE, Style::CROSS, "Clayton_Swenson" };
}
