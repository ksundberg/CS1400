#include "BrendanWinter.hpp"

/*
lionheart::Placement lionheart::BrendanWinter::placeUnit(UnitType,
                                              StartBox const &box,
                                              SituationReport report)
{
  ...
  lionheart::Action
lionheart::BrendanWinter::recommendAction(Unit const &, SituationReport, Plan)
{
...
lionheart::Blazon lionheart::BrendanWinter::getBlazon()
{
